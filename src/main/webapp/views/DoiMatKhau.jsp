                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="p-5">
                                ...
                                <form action="<c:url value='/doi-mat-khau?action=doimatkhau'/>" method="POST">
                                    <div class="form-group">
                                        <input name="email" type="email" class="form-control form-control-user" aria-describedby="emailHelp" placeholder="Email...">
                                    </div>
                                    <div class="form-group">
                                        <input name="token" type="text" class="form-control form-control-user" aria-describedby="emailHelp" placeholder="Token...">
                                    </div>
                                    <div class="form-group">
